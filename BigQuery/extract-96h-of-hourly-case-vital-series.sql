/*
Extract 96 hours of vital time series of sepsis case icustays before onset.
---------------------------------------------------------------------------------------------------------------------
- based on https://github.com/BorgwardtLab/mgp-tcn/blob/master/src/query/extract-55h-of-hourly-case-vital-series_ex1c.sql
---------------------------------------------------------------------------------------------------------------------
*/

create or replace table `bdhfa2021.project.case_96h_hourly_vitals` as
...
FROM  (
  ...
  and ce.charttime between (ch.sepsis_onset-interval '96' hour ) and ch.sepsis_onset 
