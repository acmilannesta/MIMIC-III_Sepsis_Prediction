/*
Extract 96 hours of vital time series of control group icustays before control_onset_time.
---------------------------------------------------------------------------------------------------------------------
- based on https://github.com/BorgwardtLab/mgp-tcn/blob/master/src/query/extract-55h-of-hourly-control-vital-series_ex1c.sql
---------------------------------------------------------------------------------------------------------------------
*/

create or replace table `bdhfa2021.project.control_96h_hourly_vitals` as
...
FROM  (
  ...
  and ce.charttime between (ch.control_onset_time-interval '96' hour ) and ch.control_onset_time 
